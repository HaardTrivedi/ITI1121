...
/**
 * In the application <b>Minesweeper</b>, a <b>DotButton</b> is a specialized
 * type of
 * <b>JButton</b> that represents a square in the game. It can have a number of
 * possible icons, which are found in the "icons" directory. The icon expresses
 * the state of the dot: covered, number of neighbouring mines, exploded..
 *
 *
 *
 * The icons have been found on <a href=
 * "https://en.wikipedia.org/wiki/Open_content">wikimedia</a>. The author of
 * these icons seems to be someone called
...
public class DotButton extends JButton {
    ...
    private int row, column, iconNumber;

    /**
     * Constructor used for initializing a DotButton at a specific Board
     * location, with a specific icon.
     *
     ...
     * the iconNumber used by the instance, using the method getImageIcon() to
     * get the new icon.
     *
     * @param iconNumber the iconNumber to use, based on the predefined constant
    ...
    /**
     * Returns the <b>ImageIcon</b> reference to use based on the current value
     * of the variable iconNumber.
     *

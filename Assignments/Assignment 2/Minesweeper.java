...
public class Minesweeper {
     ...
     * and starts the game. If three parameters width, heigth, number of mines
     * are passed, they are used. Otherwise, a default value is used. Defaults
     * values are also used if the paramters are too small (minimum 10 for
     * width, 5 for heigth and 1 for number of mines). Additionally, the maximum
     * number of mines is capped at width*heigth -1
     *
